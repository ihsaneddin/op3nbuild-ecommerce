...
class OrderItem < ActiveRecord::Base
  ...
  LANCE_FEE = 0.10 #this is lance fee, use for get total credit for contractor per item
 ...
 # @return [Boolean]
  ...
  # the total credit for contractor after substract by lance's fee
  #
  # @param [none]
  # @return [Decimal] tax charge on the item.
  def credit_total
    item_total - (self.class::LANCE_FEE * item_total)
  end
