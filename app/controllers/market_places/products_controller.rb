class MarketPlaces::ProductsController < MarketPlaces::BaseController

  load_and_authorize_resource class_name: 'Product'

  def index
    products = current_contractor.products.active.includes(:variants).standard_search(params[:name])
