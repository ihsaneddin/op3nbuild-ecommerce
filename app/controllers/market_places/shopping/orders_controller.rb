class MarketPlaces::Shopping::OrdersController < MarketPlaces::Shopping::BaseController
    ...
    if !@order.in_progress?
      ...
      if response = @order.create_invoice(@credit_card,
        ...
        if response.succeeded?
          ...
          redirect_to( confirmation_market_places_shopping_order_url(@order, contractor_context) ) and return
        else
