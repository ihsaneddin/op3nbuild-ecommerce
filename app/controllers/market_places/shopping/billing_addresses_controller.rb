class MarketPlaces::Shopping::BillingAddressesController < MarketPlaces::Shopping::BaseController
  ...
  def index
    if session_cart.shopping_cart_items.empty?
      ...
      redirect_to market_places_products_url(contractor_context) and return
    end
  ...
  def destroy
    ...
    redirect_to(market_places_shopping_billing_addresses_url(contractor_context))
  end
